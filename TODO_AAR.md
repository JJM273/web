...
### TODO for initial release
    - [ ] BUG death summary is counting despawns
    - [ ] BUG unit names do not match between map and lists (exists pre-fork)
    ...
    - [ ] go back and look at original code, how does it do force summary, can that be reused for group summary instead of the new function (before fixing the bug)
